...
public class SecurityFilterChainConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .csrf().disable() // karena kita tidak menggunakan html form untuk register
                .cors(Customizer.withDefaults()) // didaftarkan setelah membuat konfigurasi spring security
